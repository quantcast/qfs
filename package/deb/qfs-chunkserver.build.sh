...
install -m 644 $SOURCE_DIR/qfs/package/conf/ChunkServer.prp $QFS_BUILD_ROOT$NAME"_"$VERSION$QFS_INSTALL_PREFIX/conf

#ADD DEBIAN/control
mkdir -p $QFS_BUILD_ROOT$NAME"_"$VERSION/DEBIAN
cp $SOURCE_DIR/qfs/package/deb/qfs-chunkserver.DEBIAN.control $QFS_BUILD_ROOT$NAME"_"$VERSION/DEBIAN/control
