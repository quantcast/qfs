...
1. **QFS Client Library**: Bug fixes for object store operations and error
   handling
2. **Meta Server**: RPC flag setting fixes for object store chunks
3. **Build System**: Extensive CMake and Maven improvements
4. **Java Shim**: Complete modernization for Java 9+ compatibility
