...
/*
  CT comment- 2014: removed some of the general cases, thus now only works with w=8, not very clean though :( 
                    this needs not be changed for thread safety
*/
